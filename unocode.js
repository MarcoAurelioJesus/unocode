...
module.exports = [
...

  {
    ...
    commands: [
      /*_______Remove botão de fechamento do dialog fluxo de Aprov_______*/
      {
        type: "JSImporter",
        code: () => {
    ...
    commands: [
      {
        ...
        code: () => {
          ...
          if (tramitarPropostaLivreBtn != null && tramitarPropostaLivreBtn.length > 0) {
