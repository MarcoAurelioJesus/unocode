    ...
    nextActions: [
        ...
        guard: {
          conditions: [
            {
              code: () => {
                var topo = document.getElementById(
                  "m_cabecalho"
                );
