...

          {
            ...
            code: () => {
              setTimeout(() => {
               ...
               let x = document.querySelector("#propostaLivre_tramitarPropostaLivreDialogBoxWorkflow");
                if(plDoalogBox != null){
                  plDoalogBox.removeAttribute("class");
                }
                let tramitarPropostaLivreDialogBoxWorkflow = document.querySelector("#propostaLivre_tramitarPropostaLivreDialogBoxWorkflow");
                if(tramitarPropostaLivreDialogBoxWorkflow != null){
