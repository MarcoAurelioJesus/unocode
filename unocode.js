        ...
        commands: [
          {
            ...
            code: () => {
              ...
              var descrPrecif = document.getElementById("precificacao.asp");
              ...
              if(descrPrecif.parentElement.parentElement.parentElement.parentElement != null){
                descrPrecif.parentElement.parentElement.parentElement.parentElement.remove();
              }  
              if(tdlinha.length != 0){
                tdlinha[0].remove();
              }
