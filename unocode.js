...
module.exports = [
  ...
  /*_______Ocultar Colunas grid______*/
  {
    ...
    nextActions: [
      ...
      /*Força fixação de Dialog Fluxo*/
            {
        guard: {
          conditions: [
            {
              code: () => {
                let dialogFluxo = document.getElementsByClassName("faces-popup historico");
                if (dialogFluxo.length > 0) {
                  return dialogFluxo != null;
                }
              }
            }
          ]
        ...
        commands: [
          {
            type: "JSImporter",
            code: () => {
              var dialogFluxo = document.getElementsByClassName("faces-popup historico");
             dialogFluxo[0].removeAttribute("class");
            }
          },
        ]
      }
